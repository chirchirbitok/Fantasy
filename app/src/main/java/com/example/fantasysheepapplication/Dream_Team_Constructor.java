...
public class Dream_Team_Constructor {
    ...
    public Dream_Team_Constructor(int sheep_id, String sheep_name, int age_id, int breed_id, int gender_id, int point_id, String favorite) {
